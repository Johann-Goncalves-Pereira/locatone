...
const PROBE_SECTION: Readonly<Record<ProbeId, ProbeSection>> = {
	...
	ip_seeip: 'coordinates',
	ip_geoiplookup: 'coordinates',
...
export const PROBE_FULL_LABELS = {
	...
	ip_seeip: 'IP (seeip.org)',
	ip_geoiplookup: 'IP (geoiplookup.io)',
	...
	http_worker_intl: 'HTTP Worker Intl / idioma',
